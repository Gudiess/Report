...
namespace Report.Controllers
{
    public class UserLoginsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserLogID,email,password,type,usersId")] UserLogin userLogin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserLogID,email,password,type,usersId")] UserLogin userLogin)
        {
            if (ModelState.IsValid)
            {
